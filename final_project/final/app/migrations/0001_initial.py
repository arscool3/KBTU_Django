# Generated by Django 5.0.6 on 2024-05-18 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='app.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Salary',
            fields=[
                ...
                ('date', models.DateField()),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='salaries', to='app.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
