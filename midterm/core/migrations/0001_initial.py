    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=30)),
                ('descr', models.CharField(max_length=255)),
                ('cert', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.cert')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certs', models.ManyToManyField(to='core.cert')),
                ...
                ('passedq', models.ManyToManyField(to='core.quiz')),
