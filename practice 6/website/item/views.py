...
class ItemReviewViewSet(ModelViewSet):
...
class ItemReviewListAPIView(generics.ListCreateAPIView):
    queryset = ItemReview.objects.all()
    serializer_class = ItemReviewSerializer

class ItemReviewDetailAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = ItemReview.objects.all()
    serializer_class = ItemReviewSerializer
