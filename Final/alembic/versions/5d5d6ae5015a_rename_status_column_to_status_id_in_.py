"""Rename status column to status_id in Application table

Revision ID: 5d5d6ae5015a
Revises: bcd9660c9343
Create Date: 2024-05-11 01:52:07.231128
...
revision: str = '5d5d6ae5015a'
down_revision: Union[str, None] = 'bcd9660c9343'
...
def downgrade() -> None:
    ...
    op.add_column('application', sa.Column('status', sa.INTEGER(), autoincrement=False, nullable=False))
    ...
    op.create_foreign_key('application_status_fkey', 'application', 'status', ['status'], ['id'])
