...
from .views import DoctorListView, DoctorDetailView, DoctorAppointmentListView, DoctorAppointmentDetailView, AppointmentDetailView, VerifyDoctorLicenseView, get_profile_id_by_doctor_id
urlpatterns = [
