...
from .serializers import CounterTerroristSerializer,CounterStrikeGameSerializer,TerroristSerializer,WeaponSerializer,BombSerializer,MapSerializer

# Viewsets
# Here for practice 6 I choose 6 models
# Game, Map, Counter Terrorist, Terrorist, Weapon, Bomb

class CounterStrikeGameViewSet(viewsets.ModelViewSet):
    queryset = CounterStrikeGame.objects.all()
    serializer_class = CounterStrikeGameSerializer

class CounterTerroristViewSet(viewsets.ModelViewSet):
    queryset = CounterTerrorist.objects.all()
    serializer_class = CounterTerroristSerializer

class TerroristViewSet(viewsets.ModelViewSet):
    queryset = Terrorist.objects.all()
    serializer_class = TerroristSerializer
...
class BombViewSet(viewsets.ModelViewSet):
